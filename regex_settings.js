        ...
        <div class="inline-drawer-toggle inline-drawer-header">
            ...
            <div class="inline-drawer-content">
                ...
                <div class="quick-char-regex-checkbox-block flex-container">
                    <input type="checkbox" id="quick-char-regex-extension-active-checkbox">
                    <label for="quick-char-regex-extension-active-checkbox">Toggle Quick Char Regex</label>
                </div>
                <div class="quick-char-regex-checkbox-block flex-container">
                    <input type="checkbox" id="quick-char-regex-only-main-chat-checkbox">
                    <label for="quick-char-regex-only-main-chat-checkbox">Only Apply to Main Chat</label>
                </div>
